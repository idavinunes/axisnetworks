<!DOCTYPE html>
<html lang="en" style="background-image: url('{$WEBPATH}themes/{$THEMENAME}/images/abstrato.png'); background-size: cover; background-position: top center; height:100%;">
...
<head>
	...
	<title>Tecnomafer - {$PAGE_NAME}</title>
...
<div class="login-container" style="background: none;">
    ...
    <div class="login-header" style="background: none;">
        ...
        <div class="login-content">
            <a href="">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/Axis_Networks_branco.png" width="300" alt="Issabel logo"/>
            </a>
...
<div class="login-progressbar">
    ...
    <div class="login-bottom-links">
    <img src="{$WEBPATH}themes/{$THEMENAME}/images/Axis_Networks2_branco.png" width="180" alt="Issabel logo"/>
   <a style="color: white">   Todos os Direitos reservados <a style="color: white" href="http://axisnetworksbr.com" style="text-decoration: none;" target='_blank'>Axis Networks </a></div>
