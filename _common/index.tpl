...
<html>
    <head>
        ...
        <title>Tecnomafer Telecom</title>
    ...
    <footer class="main" style="margin-left:16px;">
        <a href="http://axisnetworksbr.com" style="color: #444; text-decoration: none;" target='_blank'> <img src="{$WEBPATH}themes/{$THEMENAME}/images/Axis_Networks.png" width="130" alt=""/></a> Axis Networks  {$currentyear}.
    </footer>
