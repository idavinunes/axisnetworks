...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/Axis_Networks_branco.png" width="200" alt="" />
            </a>
        </div>
        <!-- logo collapse icon -->
...
<div class="main-content">
    ...
    <div style="height:83px;background-image: url('{$WEBPATH}themes/{$THEMENAME}/images/abstrato.png'); background-size: cover; padding:15px;">

    <!-- Profile Info and Notifications -->
     <span style='float:left; text-align:left; padding:0px 5px 0px 0px; width:175px;' class="col-md-6 col-sm-8 clearfix">
     <img style="border:0px"  class="user-info pull-none-xsm" src="{$WEBPATH}themes/{$THEMENAME}/images/AvatarMaker.png" alt="" class="" width="65" />
     <b style="color: white">{$USER_LOGIN}</b>
     </span>
     ...
     <li style="border:0px" class="profile-info dropdown pull-right"><!-- add class "pull-right" if you want to place this from right -->
     <a  href="#" class="dropdown-toggle" data-toggle="dropdown">
     </a>
     </li>
     <li style="border:0px" >
      <a href="?logout=yes">
      <b style="color: white">Sair <i  class="entypo-logout right"></i></b>
      </a>
      </li>
      <p>
           &emsp; &emsp; &emsp;
    ...
    <span style='float:right; width:400px;'>
       ...
       <ul style="padding-top:7px;" class="list-inline links-list pull-right">
...
<ol class="breadcrumb bc-2">
    ...
    {foreach from=$BREADCRUMB item=value name=menu}
        {if $smarty.foreach.menu.first}
             <li>
                <a href="/"> <i class="entypo-home"></i></a></b>
                <a href="#"> {$value}</a>
             </li>
        {elseif $smarty.foreach.menu.last}
           <li class="active"><strong style="color: darkslategrey">{$value}</strong></li>
        {else}
   ...
   <li id="tenant-sticky" class="dropdown">
       ...
       <img src="{$WEBPATH}themes/{$THEMENAME}/images/Axis_Networks2.png" width="50" alt=""/></a>
   </li>
</ol>
